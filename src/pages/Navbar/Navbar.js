...
const Navbar = () => {
  const menuItems = <React.Fragment>
    ...
    <li className=''><Link to='/destination'>Destination</Link></li>
  ...
  return (
    <div className='w-full  sticky top-0 z-10' style={navbarShadow}>
      <div className="max-w-[1440px] mx-auto navbar flex justify-between py-0" >
        <div className="navbar-start w-full">
          ...
          <Link to='/' className="cursor-pointer normal-case text-xl pl-1 flex items-center">
            ...
            <h2 className='text-2xl font-semibold text-secondary'>Go Traveling</h2>
          </Link>
        </div>
